...
public class Project_hundir_flota {
    ...
    static void colocarbarcos(char[][] tableroin)
    ...
    
    {
        ...
        puntos[0]-- ;
            ...
            if(dentro == true)
            {
                if(tableroin[fila][columna] == 126)
                {
                    System.out.println("*****FALLASTE*****");
                    
                    tableroin[fila][columna] = 215;
                ...
                else if(tableroin[fila][columna] == 215)
                    {
                           ...
                           for(int i=0;i<nf;i++)
                            {
                                ...
                                {
                                    tablain[i][columna]=215;
                                    tablaex[i][columna]=177;
                                    puntos[1]++;
                                }
                                else if(tablain[i][columna] == 126)
                                {
                                    tablain[i][columna]=215; 
      ...
      static void atomica (char[][] tableroin,char[][] tableroex, int[] puntos)
    {
        ...
        if(dentro == true && tableroin[fila][columna] != 215)
        {
        if(tableroin[fila][columna] == 126)
                {
                    tableroin[fila][columna] = 215;
        ...
        if(dentroabajoderecha == true && tableroin[fila+1][columna+1] != 215)
        {   
            if(tableroin[fila + 1][columna +1] == 126)
                {
                    tableroin[fila + 1][columna +1] = 215;
        ...
        if(dentroarribaizquierda == true && tableroin[fila-1][columna-1] != 215)
        {           
        ...
        if(dentroabajoizquierda == true && tableroin[fila+1][columna-1] != 215)
        {
        ...
        {
            if(dentroarribaderecha == true && tableroin[fila-1][columna+1] != 215)
            {
                        if(tableroin[fila-1][columna+1] == 126)
                        {
                            tableroin[fila-1][columna+1] = 215;
        ...
        if(dentroderecha == true && tableroin[fila][columna+1] != 215)
        {
            if(tableroin[fila][columna+1] == 126)
                {
                    tableroin[fila][columna+1] = 215;
        ...
        if(dentroizquierda == true && tableroin[fila][columna-1] != 215)
        {
        ...
        {
           if(dentroabajo == true && tableroin[fila-1][columna] != 215)
        {
            
            if(tableroin[fila-1][columna] == 126)
                {
                    if(fila == -1)
                    {
        ...
        if(dentroarriba == true && tableroin[fila+1][columna] != 215)
        {
            if(tableroin[fila+1][columna] == 126)
                {
                    tableroin[fila+1][columna] = 215;
    ...
    static void tutorial()
    {
        ...
        System.out.println("opciones:");
        System.out.println();
        System.out.println("1) Disparo \t \t |dispara a 1 casilla");
        System.out.println("2) bomba atomica \t |dispara a una casilla y a todas las de su alrededor");
        System.out.println("3) flash \t \t |te muestra la ubicación de los barcos en el tablero");
        System.out.println("4) barrena \t \t |dispara a una fila o a una columna completa");
    ...
    public static void main(String[] args) {
            ...
            while(fila * columna < 56 || fila > 25 || columna >25 )
            {
